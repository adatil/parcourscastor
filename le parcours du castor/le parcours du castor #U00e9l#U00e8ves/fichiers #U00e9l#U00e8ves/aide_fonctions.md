...
## Exemple de test sans interface

Vous pouvez tester vos fonctions directement dans un terminal Python :
...
print(departArrivee(parcours, grille_1))  # Doit afficher True

# Test ordreDesCases
print(ordreDesCases(parcours, grille_1))  # Doit afficher True ou False selon le parcours
```
